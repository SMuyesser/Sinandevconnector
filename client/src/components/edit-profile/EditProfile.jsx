...
class CreateProfile extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		//check to see if profile came in from global state to props to populate component state values
		//profile object in profile state
						...
						<div className="col-md-8 m-auto">
							...
							<form onSubmit={this.onSubmit}>
								...
								<TextFieldGroup 
									...
									info="Include your username to get latest repos and Github link."
								/>
								<TextAreaFieldGroup 
